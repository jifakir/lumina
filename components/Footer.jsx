            ...
            <div className="container px-3 md:px-20 mx-auto text-center">
                <div className="py-10 md:py-28 flex flex-col md:flex-row justify-between border-b border-gray-800">
                    <div className="flex flex-col items-center justify-center">
                        <h6 className="w-full pb-5 md:pb-8 text-white text-opacity-70 text-left">Powered by :</h6>
                        <div className="w-40">
                            <Image src={binance} alt="Binance Logo" />
                        </div>
                    </div>
                    <div className="text-white">
                        <h6 className="pb-5 md:pb-8 pt-10 md:pt-0 text-white text-opacity-70 text-left">Join Social :</h6>
